...
export const EMAIL = "contact@foxassured.com";
export const GITHUB_URL = "https://github.com/FoxAssured";
export const LINKEDIN_URL = "https://www.linkedin.com/company/foxassured";
export const YOUTUBE_URL = "https://www.youtube.com/@FoxAssured";
...
export const SERVICES: Service[] = [
  {
    ...
    description:
      "Building robust, scalable automated test suites using Playwright or Cypress to reduce regression time.",
    iconName: "Bot",
  },
  {
    id: "s2",
    ...
    description:
      "Analyzing existing QA processes and implementing best practices to improve software quality culture.",
  ...
  },
  {
    ...
    description:
      "Detailed documentation of test strategies, scenarios, and cases ensuring comprehensive coverage and clear traceability.",
    iconName: "FileText",
  },
  {
    id: "s4",
    ...
    description:
      "Seamlessly integrating automated tests into pipelines (GitHub Actions, AWS) for continuous feedback.",
    iconName: "GitMerge",
  },
];
...
export const PROJECTS: Project[] = [
  {
    ...
    description:
      "A robust E2E testing framework for a complex financial application. Implements Page Object Model (POM) and handles dynamic authentication flows.",
  ...
  },
  {
    ...
    description:
      "Automated script to validate large datasets across different environments. Drastically reduced manual verification time for data migration projects.",
  ...
  },
  {
    ...
    description:
      "Integrated performance testing using K6 and security scanning with OWASP ZAP to ensure application resilience and compliance.",
