    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20 pb-20">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6 text-pastel-950 leading-tight">
          ...
          <span className="text-pastel-600">Manual & Automated</span>
        </h1>

        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
          <span className="font-semibold text-pastel-800">
            Software Development Engineer in Test.
          </span>{" "}
          Bridging the gap between manual precision and automated scalability.
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mb-16">
          ...
          <div className="w-full sm:w-auto px-4 py-4 text-pastel-900 font-bold text-base md:text-lg hover:text-pastel-600 transition-colors duration-300 flex items-center justify-center gap-2 cursor-default">
            <Mail size={20} className="flex-shrink-0" />
            <span className="select-all break-all sm:break-normal">
              {EMAIL}
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
          <div className="p-6 bg-white rounded-2xl shadow-sm border border-pastel-100 hover:border-pastel-300 transition-colors">
            ...
            <h3 className="text-pastel-900 font-bold text-lg mb-2">
              Manual QA Expert
            </h3>
            <p className="text-gray-600 text-sm">
              Rigorous attention to detail for exploratory, usability, and
              visual testing.
            </p>
          </div>
          ...
          <div className="p-6 bg-white rounded-2xl shadow-sm border border-pastel-100 hover:border-pastel-300 transition-colors">
            ...
            <p className="text-gray-600 text-sm">
              Building scalable frameworks with Playwright and Cypress.
            </p>
          </div>
          ...
          <div className="p-6 bg-white rounded-2xl shadow-sm border border-pastel-100 hover:border-pastel-300 transition-colors">
            ...
            <p className="text-gray-600 text-sm">
              Integration of testing into CI/CD pipelines ensuring rapid
              delivery.
            </p>
          </div>
        </div>
